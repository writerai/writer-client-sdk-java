...
public class AIContentDetector {
    ...
    public com.writer.sdk.models.operations.DetectContentResponse detect(com.writer.sdk.models.operations.DetectContentRequest request) throws Exception {
        ...
        com.writer.sdk.models.operations.DetectContentResponse res = new com.writer.sdk.models.operations.DetectContentResponse(contentType, null, httpRes.statusCode(), httpRes) {{
            classes = null;
            failResponse = null;
        }};
